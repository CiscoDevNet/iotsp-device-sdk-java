...
public class SpecialMessage {
   ...
   */
  public SpecialMessage(boolean sendDataToCloud, GatewayAttributes gwAttributes, Map<String, DeviceAttributes> deviceAttributes,
      Properties props) throws IoTEdgeDcClientException {
  ...
  private void initDCClient(Properties props) throws IoTEdgeDcClientException {
    ...
    String clientId = gwAttributes.getGatewayId() + "-splMsg-client"; 
