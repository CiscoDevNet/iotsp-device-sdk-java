...
cd $DEST/app; java -Xmx100m -Djava.net.preferIPv4Stack=true -XX:GCTimeRatio=4 -Djava.util.logging.config.file=logging.properties -jar iotsp-batch-store-manager-0.1.0.0-SNAPSHOT-all.jar -s -p  >> $CAF_APP_LOG_DIR/stdout.log 2>&1;
