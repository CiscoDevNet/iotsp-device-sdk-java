...
cd $DEST/app; java -Xmx100m -Djava.net.preferIPv4Stack=true -XX:GCTimeRatio=4 -Djava.util.logging.config.file=logging.properties -jar iotsp-batch-store-manager-0.3.0.6-SNAPSHOT-all.jar -s -p -d genericData.data >> $CAF_APP_LOG_DIR/stdout.log 2>&1;
